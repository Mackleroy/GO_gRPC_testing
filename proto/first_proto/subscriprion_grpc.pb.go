...
const (
	TimeService_StreamTime_FullMethodName = "/gopractic.protobuf.first_proto.TimeService/StreamTime"
)
...
func (c *timeServiceClient) StreamTime(ctx context.Context, in *Request, opts ...grpc.CallOption) (TimeService_StreamTimeClient, error) {
	stream, err := c.cc.NewStream(ctx, &TimeService_ServiceDesc.Streams[0], TimeService_StreamTime_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
var TimeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gopractic.protobuf.first_proto.TimeService",
